...
psql -Ugoggin lomd -c "\copy box_scores(season, week_id, team_id, player_id, position, points, projected_points, pro_pos_rank, game_played, playoff) FROM 'data/box_scores.csv' DELIMITER ',';"
